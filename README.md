...
| ---- | ------------- | ------------- |
|1| PriorityQueue\<E\> | . order not preserved, allows duplicates, no null values, not thread safe <br> It does not follow the FIFO order and store elements based on their priority |
